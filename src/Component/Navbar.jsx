        ...
        <div className="container flex flex-wrap items-center justify-between w-full px-3 mx-auto">
            ...
            <div className="!visible mt-2 hidden ms-5 flex-grow basis-[100%] items-center lg:mt-0 lg:!flex lg:basis-auto"
                ...
                <div className="flex gap-2">
                    <div className="px-2 py-3 font-bold text-2xl text-center text-blue-500 transition-all duration-100 ease-in-out border-transparent text-2xlfont-black bg-white-500 hover:underline underline-offset-4 ring-offset-orange-500">
                    Speakers
                    </div>
                    <div className="px-2 py-3 font-bold text-2xl text-center text-blue-500 transition-all duration-100 ease-in-out border-transparent text-2xlfont-black bg-white-500 hover:underline underline-offset-4 ring-offset-orange-500 ">
                    Contact
                    </div>
                    <div className="px-2 py-3 text-2xl font-bold text-center text-blue-500 transition-all duration-100 ease-in-out border-transparent te bg-white-500 hover:underline underline-offset-4 ring-offset-orange-500 ">
                    Venue
                    </div>
                    <div className="flex items-center justify-center px-2 text-lg font-bold text-blue-500 transition duration-150 ease-out bg-yellow-500 rounded-md cursor-pointer hover:bg-white-700 hover:ease-in hover:text-white">
